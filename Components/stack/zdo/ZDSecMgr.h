...
extern CONST uint8 gZDSECMGR_TC_DEVICE_MAX;
extern CONST uint8 gZDSECMGR_TC_DEVICE_IC_MAX;

typedef struct
{
uint32              FrameCounter;
uint8               extendedPanID[Z_EXTADDR_LEN];   //to associate the nwk with the 
