...
#define PROXY_TBL_ENTRY_LEN           64   // in bytes   
...
#define PROXY_TBL_ENTRY_1ST_GRP_ADDR      54
#define PROXY_TBL_ENTRY_2ND_GRP_ADDR      58
#define PROXY_TBL_ENTRY_GRP_RAD           62
#define PROXY_TBL_ENTRY_SEARCH_COUNTER    63
 ...
 */
extern ZStatus_t zclGp_SendGpNotificationCommand( gpNotificationCmd_t *cmd );
